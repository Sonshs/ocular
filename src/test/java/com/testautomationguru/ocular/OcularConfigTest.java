...
public class OcularConfigTest {
    ...
    public void ocularCompareUsingPath() {
        ...
        Path samplePath = Paths.get(System.getProperty("user.dir"), "src/test/resources/image-compare/RichFaces-Poll.png"); // RichFacesTheme-classic.png
        
        System.out.println(snapshotPath.toString());
